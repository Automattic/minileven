 ...
 * Load plugin's utility functions.
 *
 * @package Minileven
 */
...
/**
 * Update the URI for themes directory.
 *
 * @param string $theme_root_uri The URI for themes directory.
 */
function minileven_theme_root_uri( $theme_root_uri ) {
	if ( jetpack_check_mobile() ) {
		return plugins_url( 'src/theme', dirname( __FILE__ ) );
	}
...
function jetpack_mobile_available() {
	...
	$anchor = '<a href="' . esc_url( $target_url ) . '">' . __( 'View Mobile Site', 'minileven' ) . '</a>';
...
function jetpack_mobile_css_settings() {
	...
	<div class="misc-pub-section">
		<label><?php esc_html_e( 'Mobile-compatible:', 'minileven' ); ?></label>
		<span id="mobile-css-display"><?php echo $mobile_css ? __( 'Yes', 'minileven' ) : __( 'No', 'minileven' ); ?></span>
		<a class="edit-mobile-css hide-if-no-js" href="#mobile-css"><?php echo esc_html_e( 'Edit', 'minileven' ); ?></a>
		<div id="mobile-css-select" class="hide-if-js">
			...
			<label>
				...
				<?php esc_html_e( 'Include this CSS in the Mobile Theme', 'minileven' ); ?>
			</label>
			<p>
				<a class="save-mobile-css hide-if-no-js button" href="#mobile-css"><?php esc_html_e( 'OK', 'minileven' ); ?></a>
				<a class="cancel-mobile-css hide-if-no-js" href="#mobile-css"><?php esc_html_e( 'Cancel', 'minileven' ); ?></a>
			</p>
		</div>
	</div>
	<script type="text/javascript">
...
function jetpack_mobile_customizer_controls( $wp_customize ) {
	...
	$wp_customize->add_control( 'jetpack_mobile_css_control', array(
		'type' => 'checkbox',
		'label' => __( 'Include this CSS in the Mobile Theme', 'minileven' ),
