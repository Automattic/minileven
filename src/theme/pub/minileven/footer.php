...
<footer id="colophon" role="contentinfo">
	<div id="site-generator">
		...
		<a href="<?php echo esc_url( $target_url ); ?>"><?php _e( 'View Full Site', 'minileven' ); ?></a>
		<br />
		...
		<a href="<?php echo esc_url( __( 'https://wordpress.org/', 'minileven' ) ); ?>" rel="noopener noreferrer" target="_blank" title="<?php esc_attr_e( 'Semantic Personal Publishing Platform', 'minileven' ); ?>" rel="generator"><?php printf( __( 'Proudly powered by %s', 'minileven' ), 'WordPress' ); ?></a>
	</div>
</footer><!-- #colophon -->
