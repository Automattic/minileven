...
?>
				...
				<nav id="nav-single">
					<h3 class="assistive-text"><?php _ex( 'Image navigation', 'next-saturday' , 'minileven' ); ?></h3>
					<span class="nav-previous"><?php previous_image_link( false, __( '&laquo; Previous' , 'minileven' ) ); ?></span>
